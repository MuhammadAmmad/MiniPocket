...
public class Sagittarius extends AppCompatActivity implements ViewPager.OnPageChangeListener, TabHost.OnTabChangeListener {
    private View view;
    ViewPager viewPager;
    TabHost tabhost;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initTabHost();
        initViewPager();
        Sagittarius.this.setTitle("Sagittarius");
    }
