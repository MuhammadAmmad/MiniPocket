package com.example.roshan.minipocket.Taurus;
...
public class This_Month extends Fragment {
    ...
    private static String url = "http://10.42.0.1/Horoscope/taurus.php";
    ...
    private class GetContacts extends AsyncTask<String, Object, String> {
            ...
            if (jsonStr != null) {
                try {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        student.put("This_Month", This_Month);
        ...
        protected void onPostExecute(String result) {
            ...
            ListAdapter adapter = new SimpleAdapter(
                    ...
                    R.layout.fragment_yesterday, new String[]{ "This_Month","Week_Date"}, new int[]{
